...
if __name__ == "__main__":
    PREDICT_FILE = "/root/autodl-tmp/LLaMA-Factory/outputs/v4.1/generated_predictions.jsonl"
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=3) as executor:
        list(tqdm(executor.map(process_single_sample, range(total_samples)), total=total_samples, desc="V4.1 评测进度"))

    print("\n" + "="*50)
    print(f"🏆 V4.1 模型评测报告 (样本数: {total_samples})")
